    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto py-32 px-4 text-center">
        ...
        <p className="text-xl text-gray-600">
          Notre guide des leurres est en cours de rédaction. Revenez bientôt pour découvrir notre sélection détaillée des meilleurs leurres pour la pêche ultra-light.
        </p>
      </div>
    </div>
  );
